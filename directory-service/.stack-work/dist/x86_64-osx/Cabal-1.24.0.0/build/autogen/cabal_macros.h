...
/* package directory-service-0.1.0.0 */
#define VERSION_directory_service "0.1.0.0"
#define MIN_VERSION_directory_service(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "directory-service-0.1.0.0-8hrHeNl69sRGBzv9xeAZh0"

#define CURRENT_PACKAGE_KEY "directory-service-0.1.0.0-8hrHeNl69sRGBzv9xeAZh0"
